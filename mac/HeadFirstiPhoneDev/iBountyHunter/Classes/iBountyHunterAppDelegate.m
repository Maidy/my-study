...
//	NSURL *writableDBPath = [documentDirectory URLByAppendingPathComponent:@"iBountyHunter.sqlite"];
	...
	// BOOL dbexists = [fileManager fileExistsAtPath:[writableDBPath absoluteString]];
	
	if (!dbexists) {
		// NSURL *defaultDBPath = [[[NSBundle mainBundle] resourceURL] URLByAppendingPathComponent:@"iBountyHunter.sqlite"];
